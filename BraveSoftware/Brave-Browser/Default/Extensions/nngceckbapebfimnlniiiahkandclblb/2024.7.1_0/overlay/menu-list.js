...
class AutofillInlineMenuList extends AutofillInlineMenuPageElement {
     ...
     * @param portKey - Background generated key that allows the port to communicate with the background.
     */
    initAutofillInlineMenuList({ translations, styleSheetUrl, theme, authStatus, ciphers, portKey, }) {
    ...
    focusInlineMenuList() {
        ...
        const newItemButtonElement = this.inlineMenuListContainer.querySelector("#new-item-button");
        if (newItemButtonElement) {
            newItemButtonElement.focus();
            return;
        }
        const firstCipherElement = this.inlineMenuListContainer.querySelector(".fill-cipher-button");
