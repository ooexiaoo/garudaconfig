...
class AutofillInlineMenuIframeService {
    ...
    initMenuIframe() {
        ...
        this.updateElementStyles(this.iframe, Object.assign(Object.assign({}, this.iframeStyles), this.initStyles));
    ...
    handleFadeInInlineMenuIframe() {
        this.clearFadeInTimeout();
        this.fadeInTimeout = globalThis.setTimeout(() => this.updateElementStyles(this.iframe, { display: "block", opacity: "1" }), 10);
    }
    /**
...
class AutofillInlineMenuContentService {
    constructor() {
         ...
         * body element.
         */
        this.handleBodyElementMutationObserverUpdate = () => autofill_inline_menu_content_service_awaiter(this, void 0, void 0, function* () {
            ...
            if (!lastChild ||
                ...
                (lastChildIsInlineMenuButton && !(yield this.isInlineMenuListVisible()))) {
                return;
            }
...
class AutofillOverlayContentService {
    ...
    setupInlineMenu(formFieldElement, autofillFieldData, pageDetails) {
        return autofill_overlay_content_service_awaiter(this, void 0, void 0, function* () {
            ...
            yield this.setupInlineMenuOnQualifiedField(formFieldElement);
        });
    }
    /**
        ...
        return autofill_overlay_content_service_awaiter(this, void 0, void 0, function* () {
            ...
            if (this.inlineMenuVisibility === AutofillOverlayVisibility.OnButtonClick ||
                (initiallyFocusedField !== this.mostRecentlyFocusedField &&
                    (yield this.hideInlineMenuListOnFilledField(formFieldElement)))) {
     ...
     */
    setupInlineMenuOnQualifiedField(formFieldElement) {
        return autofill_overlay_content_service_awaiter(this, void 0, void 0, function* () {
...
class InlineMenuFieldQualificationService {
    constructor() {
        ...
        this.excludedAutofillLoginTypesSet = new Set(AutoFillConstants.ExcludedAutofillLoginTypes);
        this.usernameFieldTypes = new Set(["text", "email", "number", "tel"]);
        this.usernameAutocompleteValues = new Set(["username", "email"]);
        ...
        this.currentPasswordAutocompleteValues = new Set(["current-password"]);
        this.newPasswordAutoCompleteValues = new Set(["new-password"]);
        ...
        this.accountCreationFieldKeywords = new Set([
            "register",
            "registration",
            "create",
            "confirm",
        ...
        this.isCurrentPasswordField = (field) => {
            if (this.fieldContainsAutocompleteValues(field.autoCompleteType, this.newPasswordAutoCompleteValues) ||
        ...
        this.isNewPasswordField = (field) => {
            if (this.fieldContainsAutocompleteValues(field.autoCompleteType, this.currentPasswordAutocompleteValues)) {
                return false;
            }
            return (this.isPasswordField(field) &&
                this.keywordsFoundInFieldData(field, [...this.accountCreationFieldKeywords]));
    ...
    isPasswordFieldForLoginForm(field, pageDetails) {
        ...
        if (!parentForm) {
            ...
            return !this.fieldContainsAutocompleteValues(field.autoCompleteType, this.autocompleteDisabledValues);
        }
    ...
    isUsernameFieldForLoginForm(field, pageDetails) {
        ...
        if (this.fieldContainsAutocompleteValues(field.autoCompleteType, this.usernameAutocompleteValues)) {
        ...
        if (passwordFieldsInPageDetails.length === 0) {
            ...
            if (this.fieldContainsAutocompleteValues(field.autoCompleteType, this.autocompleteDisabledValues)) {
                return false;
            }
     ...
     */
    fieldContainsAutocompleteValues(fieldAutocompleteValue, compareValues) {
