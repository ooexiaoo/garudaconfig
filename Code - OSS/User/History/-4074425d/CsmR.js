themeButtons.forEach((color, index) => {
  color.addEventListener("click", () => {
    ...
    const bgImage = localStorage.getItem(dataColor);
    if (bgImage) {
      document.querySelector(":root").style.setProperty("--pomodoro", 'customBackground');
    } else {
      document.querySelector(":root").style.setProperty("--pomodoro", 'customBackgroundUrl');
    }
