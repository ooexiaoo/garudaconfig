...
colorPicker.on('color:change', function(color) {
  ...
  if (color.hexString === 'none') {
    ...
    console.log('Selected color is "none". Applying none background.');
    ...
    try {
      ...
      console.log('Retrieved custom background URL from localStorage:', customBackgroundUrl);
      
      // Check if customBackgroundUrl is not null
      if (customBackgroundUrl) {
        // Apply the custom background URL from localStorage
        console.log('Applying custom background from localStorage:', customBackgroundUrl);
