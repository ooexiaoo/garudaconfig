...
const MyComponent = () => {
  ...
  return (
    <div className='w-full flex flex-col min-h-screen items-center justify-center'>
        ...
        <form action="https://duckduckgo.com/" target="_blank" method="GET" className="flex search-bar items-center justify-center" data-theme='synthwave>
          <input className="flex search text-center input input-bordered input-accent w-full max-w-xs" type="text" placeholder="Search Here" name="q" />
          <button className='btn btn-accent' data-theme='synthwave'
            type="submit">
            <Image
