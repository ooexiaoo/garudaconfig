...
const MyComponent = () => {
  ...
  function updateGreeting(username: string) {
    ...
    // Update state with greeting and image path
    // You can use state to render dynamic content instead of directly updating innerHTML
  }  
    ...
    <div className='w-full flex flex-col min-h-screen items-center justify-center'>
      <div className="bg-img">
        ...
        <form action="https://duckduckgo.com/" target="_blank" method="GET" className="flex search-bar items-center justify-center">
          ...
          <button type="submit">
            <Image src="/icons8-search.svg" alt="Search" width={20} height={20} />
          </button>
        </form>
      </div>
    </div>
